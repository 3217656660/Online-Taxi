...
-- 创建司机表
CREATE TABLE driver (
                        id INT PRIMARY KEY AUTO_INCREMENT NOT NULL COMMENT '司机ID',
...
CREATE TABLE payment (
                         id INT PRIMARY KEY AUTO_INCREMENT NOT NULL COMMENT '支付ID',
...
-- 创建评价表
CREATE TABLE review (
                        id INT PRIMARY KEY AUTO_INCREMENT NOT NULL COMMENT '评价ID',
                        order_id INT NOT NULL COMMENT '订单ID（外键关联）',
